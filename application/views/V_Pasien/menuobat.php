      ...
      <div class="row justify-content-between">
        <div class="col-5 text-center form-inline">
          <div class="text-uppercase mr-3">
            <a class="btn btn-outline-dark" href="<?= base_url();?>C_Pasien/menuobat" role="button" style="width:90px">ALL</a>
          </div>
          <div class="text-uppercase mr-3">
            <a class="btn btn-outline-dark" href="<?= base_url();?>C_Pasien/filterluar" role="button" style="width:90px">luar</a>
          </div>
          <div class="text-uppercase mr-3">
            <a class="btn btn-outline-dark" href="<?= base_url();?>C_Pasien/filterdalam" role="button" style="width:90px">dalam</a>
          </div>
        </div>
          ...
          <div class="col-4 text-center">
            <div class="bg-light px-3 py-1 my-2 border border-dark font-weight-bold">
              ...
              <div class="py-2 text-left">
                ...
                <!-- beli obat -->
                <a href="<?= base_url();?>C_Pasien/pesankeranjang/<?php echo $data['kode_obat'] ?>" class="btn btn-outline-success float-right" role="button"style="width:85px"><span class="fa fa-shopping-cart pr-2"></span>beli</a>
              </div>
            </div>
          </div>
        <?php }?>
