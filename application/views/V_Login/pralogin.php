        ...
        <div class="container my-3">
            <div class="row">
                <div class="col-8">
                    ...
                    <div class="media">
                        <img class="align-self-center mr-3" src="<? echo base_url();?>/images/logo.png">
                ...
                <div class="col-4 text-center">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="<? echo site_url('C_Home/login_d'); ?>"  class="btn btn-outline-secondary"><img src="<?= base_url(); ?>/images/doctor.png" width="100"  class="rounded-circle"></a>
                            <h5 >Dokter</h5>
                        </div>
                        <div class="col-6">
